...
@Sql(value = {"/prepare-message-after.sql", "/prepare-user-after.sql"}, executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
public class MainControllerTest {
    ...
    public void addMessageTest() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=11]/div/span").string("fifth"))
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=11]/div/p/i").string("#new"));
    }
}